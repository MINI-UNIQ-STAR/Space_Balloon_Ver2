...
int main(void)
{
  ...
  // Optional: enable Independent Watchdog. Default is OFF unless APP_ENABLE_IWDG is set.
  // Choose a conservative timeout to tolerate temporary I2C/UART stalls.
#if defined(APP_ENABLE_IWDG) && (APP_ENABLE_IWDG != 0)
  (void)iwdg_simple_init_ms(8000u);
#endif
