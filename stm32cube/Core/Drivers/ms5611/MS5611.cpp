...
osr_t MS5611::getOversampling() const { return (osr_t)_samplingRate; }
...
void MS5611::setPressureOffset(float offset) { _pressureOffset = offset; }

float MS5611::getPressureOffset() { return _pressureOffset; }

void MS5611::setTemperatureOffset(float offset) { _temperatureOffset = offset; }

float MS5611::getTemperatureOffset() { return _temperatureOffset; }

//  (from MS5837)
//  https://www.mide.com/air-pressure-at-altitude-calculator
//  https://community.bosch-sensortec.com/t5/Question-and-answers/How-to-calculate-the-altitude-from-the-pressure-sensor-data/qaq-p/5702
//  (stale link). https://en.wikipedia.org/wiki/Pressure_altitude
...
int MS5611::getLastResult() const { return _result; }

uint32_t MS5611::lastRead() const { return _lastRead; }

uint32_t MS5611::getDeviceID() const { return _deviceID; }

void MS5611::setCompensation(bool flag) { _compensation = flag; }

bool MS5611::getCompensation() { return _compensation; }

//       EXPERIMENTAL
uint16_t MS5611::getManufacturer() { return readProm(0); }

//       EXPERIMENTAL
uint16_t MS5611::getSerialCode() { return readProm(7) >> 4; }

//       DEVELOP
uint16_t MS5611::getProm(uint8_t index) { return readProm(index); }

//       DEVELOP
uint16_t MS5611::getCRC() { return readProm(7) & 0x0F; }
