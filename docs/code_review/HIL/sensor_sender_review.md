...
| 항목 | 값 |
|------|------|
| **포맷** | `<IHH3i3i3fhhhhiifBBBBBBB5BHHHHHhHIhHBBffff` |
| **페이로드 크기** | 116 바이트 |
| **동기화** | `Core/Inc/telemetry.h` 완전 일치 |

## 위성별 위성 수 지원
- ✅ GPS, GLONASS, Galileo, BeiDou 개별 파싱
- ✅ CSV 로그에 위성 정보 기록
...
**HITL 통합 테스트 골든 레퍼런스. 116바이트 텔레메트리 완전 호환.**
